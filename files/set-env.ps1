...
Write-Host "VBOX_USER_HOME=%VBOX_USER_HOME%"
Write-Host "VBOX_INSTALL_PATH=%VBOX_INSTALL_PATH%"
...
$env:Path = "$env:VAGRANTDIR\bin;$env:RUBYDIR\bin;$env:GITDIR\cmd;$env:KDIFF3DIR;$env:CYGWINRSYNCDIR;$env:CYGWINSSHDIR;$env:CONSOLE2DIR;$env:SUBLIMEDIR;$env:PUTTYDIR;$env:VBOX_INSTALL_PATH;$env:Path"