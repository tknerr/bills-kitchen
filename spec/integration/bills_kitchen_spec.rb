...
describe "bills kitchen" do
  ...
  describe "tools" do
    it "installs ChefDK 0.5.0.rc.3" do
      run_cmd("chef -v").should match('Chef Development Kit Version: 0.5.0.rc.3')
    end
  ...
  describe "ruby installations" do
    ...
    describe "chefdk ruby" do
      it "installs Chef 12.2.1" do
        run_cmd("knife -v").should match('Chef: 12.2.1')
      end
