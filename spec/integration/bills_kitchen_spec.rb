...
describe "bills kitchen" do
  ...
  describe "tools" do
    ...
    it "installs Terraform 0.5.2" do
      run_cmd("terraform --version").should match('0.5.2')
    end
    it "installs Packer 0.7.5" do
      run_cmd("packer version").should match('0.7.5')
    end
    it "installs Consul 0.5.1" do
      run_cmd("consul --version").should match('0.5.1')
    end
    ...
    it "installs atom 0.199.0" do
      ...
      cmd_succeeds "grep 'Package: atom@0.199.0' #{BUILD_DIR}/tools/atom/Atom/resources/LICENSE.md"
    end
    it "installs apm 0.167.0" do
      run_cmd("#{BUILD_DIR}/tools/atom/Atom/resources/app/apm/bin/apm.cmd -v").should match('0.167.0')
    end
