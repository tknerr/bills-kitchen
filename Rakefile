...
def download_tools
  [
    ...
    %w{ github.com/atom/atom/releases/download/v0.196.0/atom-windows.zip                                    atom },
    ...
    %w{ opscode-omnibus-packages.s3.amazonaws.com/windows/2008r2/x86_64/chefdk-0.5.1-1.msi                  chef-dk }
  ]
